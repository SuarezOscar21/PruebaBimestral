...
public class MantenimientoFacadeREST extends AbstractFacade<Mantenimiento> {
    ...
    public String NuevoMantenimiento(
            @FormParam("idMantenimiento") Integer idMantenimiento,
            @FormParam("Mantenimiento") String Mantenimentocol,
            @FormParam("IdVehiculo") Integer idVehiculo,
            @FormParam("idCliente") Integer idCliente,
            @FormParam("Fecha") date Fecha,
            @FormParam("Descripcion") String Descripcion,
            @FormParam("Kilometraje") Integer Kilometraje) {

        Mantenimiento mantenimiento = new Mantenimiento(idMantenimiento,
                Mantenimentocol,
                idVehiculo,
                idCliente,
                Fecha,
        ...
        return "se ha registrado un nuevo mantenimiento";
    }
    @POST
    @Path("{Editar")
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON})
    public String Editar( @FormParam("idMantenimiento") Integer idMantenimiento,
            @FormParam("Mantenimiento") String Mantenimentocol,
            @FormParam("IdVehiculo") Integer idVehiculo,
            @FormParam("idCliente") Integer idCliente,
            @FormParam("Fecha") date Fecha,
        ...
        Mantenimiento mantenimiento=super.find(idMantenimiento);
        super.edit(mantenimiento);
